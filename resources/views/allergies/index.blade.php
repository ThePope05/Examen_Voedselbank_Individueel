...
<body>
    ...
    <form action="{{ route('allergies.filter') }}" method="GET" id="filterForm">
    ...
    <!-- Tabel wordt alleen weergegeven als er gezinnen zijn -->
    <div id="gezinnenTable">
        <table border="1">
            <thead>
                <tr>
                    <th>Naam</th>
    ...
    <div style="margin-top: 20px;">
        ...
        <button onclick="window.location.href='{{ route('allergies.index') }}'">Terug</button>
    </div>
</body>
